		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comkposmeddapplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkposmeddapplication-display": {
								"semanticObject": "comkposmeddapplication",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.kpo.sm.eddapplication",
									"url": sap.ui.require.toUrl("com/kpo/sm/eddapplication")
								}
							}
						}
					}
